...
const authConfigContent = computed<AuthConfigContent>(() => {
    if (showRecoveryInput.value) {
        return {
            title: 'Herstelcode',
            description:
                'Bevestig toegang tot uw account door een van uw noodherstelcodes in te voeren.',
    ...
    return {
        ...
        description:
            'Voer de authenticatiecode in die door uw authenticator-app wordt verstrekt.',
